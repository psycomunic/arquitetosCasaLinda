          ...
          <div className="container mx-auto relative z-10 text-center space-y-16">
            ...
            <div className="flex flex-wrap justify-center gap-4 md:gap-6 mb-16">
              {[
                ...
                <div key={i} className="glass-white border-white/10 px-6 py-3 rounded-full flex items-center gap-3 group transition-all hover:bg-white/10 hover:scale-105">
                  <span className="text-gold group-hover:rotate-12 transition-transform">{badge.icon}</span>
                  <span className="text-[9px] md:text-[10px] uppercase tracking-[0.4em] text-zinc-300 font-bold whitespace-nowrap">{badge.text}</span>
                </div>
              ))}
            </div>
            ...
            <div className="space-y-8">
              <h1 className="text-5xl sm:text-6xl md:text-8xl lg:text-[7rem] font-serif leading-[1] md:leading-tight tracking-tighter text-white max-w-6xl mx-auto drop-shadow-2xl">
                ...
                <span className="text-gradient-gold italic block mt-6 animate-slide-up delay-200">quadros e espelhos do Brasil.</span>
              </h1>
