...
export const Landing: React.FC<LandingProps> = ({ onEnter }) => {
  ...
  return (
    <div className="flex flex-col bg-canvas selection:bg-gold selection:text-black">
      ...
      {/* Glass Navigation */}
      <nav className={`fixed top-0 w-full z-50 px-6 md:px-12 py-5 flex justify-between items-center transition-all duration-700 ${
        scrolled ? 'glass-dark py-4' : 'bg-transparent'
      }`}>
        <div className="text-2xl font-serif tracking-[0.4em] uppercase text-white">
      ...
      <footer className="py-20 px-6 md:px-12 bg-ebonite border-t border-white/5">
        <div className="flex flex-col md:flex-row justify-between items-start gap-16">
          <div className="space-y-8">
            <div className="text-3xl font-serif tracking-[0.4em] uppercase text-white">
              CASA <span className="italic font-light text-gold">LINDA</span>
            </div>
            <div className="space-y-2">
